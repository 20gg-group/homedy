...
//        })
    ...
    private fun exampleData() : MutableList<Post> {
        ...
        return mutableListOf(
                Post(user,
                        "Phòng full nội thất, giờ tự do, có thang máy, giường tủ máy lạnh tivi, mới xây ( cv làng hoa )",
                ...
                Post(user,
                        "Căn hộ mini full nội thất, có bếp, tivi, tủ lạnh máy giặt, máy lạnh giờ tự do. Sát sân bay công viên gia định",
                ...
                Post(user,
                        "CHO THUÊ MẶT BẰNG, NHÀ NGUYÊN CĂN, VĂN PHÒNG KINH DOANH, KHU VỰC QUẬN 9",
                ...
                Post(user,
                        "CHO THUÊ CĂN HỘ CAO CẤP ĐẦY ĐỦ TIỆN NGHI FULL NỘI THẤT NGAY NGÃ TƯ PHAN ĐĂNG LƯU. PHÒNG SẠCH SẼ MỚI 100%",
                ...
                Post(user,
                        "CĂN HỘ TIỆN ÍCH ROYAL APARTMENT NGAY THÀNH THÁI, TÔ HIẾN THÀNH, QUẬN 10",
